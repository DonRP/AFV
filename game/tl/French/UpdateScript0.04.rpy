...
translate french nightly_sixtynine_68b3cf58:
    ...
    "{i}'La libido de Sidney doit être d'au moins 8 points au début de leur conversation pour pouvoir faire encore un soixante-neuf.'{/i}"
...
translate french maid_outfit_fitting_6621a290:
    ...
    "{i}{b}«Soumission de tante Camille +1»{/b}{/i}"
...
translate french maid_outfit_fitting_63a0166e:
    ...
    "{i}{b}«Affection de tante Camille +1»{/b}{/i}"
...
translate french aunt_clean_lounge_4ad552f7:
    ...
    "{i}'Vous ne pouvez plus obtenir plus de points d'affection avec cet événement'{/i}"
...
translate french aunt_clean_lounge_686a0efd:
    ...
    "{i}{b}«Libido de tante Camille -3»{/b}{/i}"
...
translate french aunt_clean_lounge_7f19d15e:
    ...
    "{i}'Pour que tante Camille vous révèle sont intimité, elle doit vous avoir déjà montré ça dans la salle de bain. De plus, vous avez besoin de la libido ou de la soumission de Camille à 10 points.'{/i}"
...
translate french aunt_clean_lounge_1391e4ec:
    ...
    "{i}'Pour que tante Camille vous montre à nouveau ses seins, vous aurez besoin soit des points de libido de Camille, soit de points de soumission à 10.'{/i}"
...
translate french aunt_clean_bath_0b75a4a7:
    ...
    "{i}'tante Camilleest très impressionnée!.... Bien joué! Libido de tante Camille +8'{/i}"
...
translate french aunt_clean_bath_6e4f47d4:
    ...
    "{i}{b}«Libido de tante Camille +2»{/b}{/i}"
...
translate french aunt_clean_bath_4ec7d5db:
    ...
    "{i}'Pour que tante Camille s'expose, il faut avoir sa soumission à 10 points, ou sa libido à 10 points.'{/i}"
...
translate french wr_cosplayfitting_7097a829:
    ...
    "{i}'(AVERTISSEMENT - Vous ne pouvez pas commencer la séance photo de Sidney avant d'avoir acheté à la fois l'écran vert et les spots professionnels!!)'{/i}"
...
translate french assign_chores_3612837d:
    ...
    "{i}'(Vous ne pouvez pas gagner plus de points de soumission de cette partie de l'événement.)'{/i}"
...
translate french assign_chores_c719a343:
    ...
    "Commençons doucement avec le salon. La plupart du temps, il suffit de dépoussiérer, de frotter et de balayer le sol."
...
translate french aunt_clean_kitchen_638f1b3c:
    ...
    "{i}'Vous ne pouvez plus obtenir de points de soumission avec cet événement.'{/i}"
...
translate french aunt_clean_kitchen_d82b080e:
    ...
    "{i}{b}«Libido de tante Camille -1»{/b}{/i}"
...
translate french aunt_clean_kitchen_c92e99be:
    ...
    "{i}'Pour que tante Camille vous montre ses parties intimes, demandez-lui d'abord cela dans la salle de bain, puis assurez-vous que vous avez sa libido ou ses points de soumission à au moins 10.'{/i}"
...
translate french aunt_clean_kitchen_567e62ac:
    ...
    "{i}'Pour que tante Camille vous offre un autre Akabur spécial, assurez-vous que sa libido ou sa soumission soyent à au moins 10.'{/i}"
...
translate french wrshoot_adffdf16:
    ...
    "Sidney n'est disponible pour prendre des photos que l'après-midi."
...
translate french wrshoot_0782ab8b:
    ...
    "Vous avez entièrement terminé cette séance photo avec Sidney."
...
translate french wrshoot_e5187978:
    ...
    "Vous pouvez toujours participer à l'événement, mais vous ne pourrez pas augmenter les statistiques de Sidney, ni générer plus de likes pour le site Web Cosplay Heaven."
...
translate french wrshoot_5c00a2d4:
    ...
    "Vous avez déjà fait cette séance photo avec Sidney cette semaine."
...
translate french wrshoot_d4d19752:
    ...
    "Vous serez toujours en mesure d'augmenter les statistiques de Sidney et de progresser sur cette scène,"
...
translate french wrshoot_b07e76b4:
    ...
    "Pour que Sidney enlève son short, vous devez avoir sa soumission à 5 points ou sa libido à 9 points."
...
translate french wrshoot_e296d061:
    ...
    "Pour que Sidney enlève sa chemise, vous devez avoir sa soumission à 7 points ou sa libido à 9 points."
...
translate french wrshoot_82d4f94a:
    ...
    "Pour que Sidney montre ses seins, vous devez avoir sa soumission à 10 points, ou sa libido à 10 points."
...
translate french wrshoot_931b81a5:
    ...
    "Pour que Sidney vous laisse déchirer ses sous-vêtements, vous devez avoir ses points de soumission à 14."
...
translate french wrshoot_473fc3b2:
    ...
    "Pour que Sidney vous laisse faire des gros plans, vous devez avoir ses points de soumission à 19."
...
translate french wrshoot_3c6ff5a6:
    ...
    "Pour que Sidney vous laisse lui donner un coup de fouet, vous devez avoir ses points de soumission à 25."
...
translate french removeshirt_43f46b1d:
    ...
    "Pour que Sidney vous laisse prendre des gros plans explicites, vous devez avoir ses points de soumission à 19."
