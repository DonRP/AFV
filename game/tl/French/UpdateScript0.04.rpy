...
msgstr "[ST] {i}Pourquoi je ne veux pas qu'il ait le béguin pour elle?{/i}"
...
msgstr "{i}'La libido de Sidney doit être d'au moins 8 points au début de leur conversation pour pouloir faire encore un soixante-neuf.'{/i}"
...
msgstr "[RT] {i}Oh, merde !.... Tante Camille cherche du sang!{/i}"
...
msgstr "[C] .... {i}(murmure fort){/i} Camille..."
...
msgstr "{i}'Pour que tante Camille vous montre à nouveau ses seins, vous aurez besoin soit des points de la libido de Camille, soit de points de soumission à 10.'{/i}"
...
msgstr "[C] {i}(gémissement){/i} C'est en fait Camille..."
...
msgstr "[M] Ne joue pas.... recherche."
...
msgstr "[ST] {i}Ha! J'espère que j'aurais plus de likes. J'adorerais lui masser le visage.{/i}"
...
msgstr "[RT] {i}Ma belle soeur Sidney bien sûr!{/i}"
...
msgstr "[RT] {i}Toujours ma belle soeur Sidney!{/i}"
