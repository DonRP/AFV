...
translate crowdin lblCheckRoll_38a91ca2:
    ...
    RLT_dealer "Vous gagnez! Le chiffre sélectionné est [theRoll] et c'est [theRollOddOrEven_text], la couleur est [theRollColor_text]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate crowdin lblCheckRoll_bf9f0393:
    ...
    RLT_dealer "Vous avez perdu ! Le nombre que vous auriez dû sélectionné est [theRoll] et c'est [theRollOddOrEven_text], la couleur est [theRollColor_text]!{w=3.0}{nw}" with Dissolve(2.0)
