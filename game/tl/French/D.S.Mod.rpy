...
msgstr "nom de l’étiquette : [store.current_label]"

msgid "iPatch: [persistent.patreonsafe]"
msgstr "iCorrectif: [persistent.patreonsafe]"
...
msgstr "{color=#00589E} Points_et_objets--------------{/color}"

msgid "{color=#1DDB16}Add{/color}/{color=#E60000}Remove{/color} items"
msgstr "{color=#1DDB16} Ajouter {/color}/{color=#E60000} Supprimer des éléments {/color}"

msgid "Change girls stats"
msgstr "Changer les statistiques des filles"

msgid "{color=#00589E}Time:[timeofdaycounter]-----------------------------{/color}"
msgstr "{couleur=#00589E} Heure :[timeofdaycounter]-----------------------------{/color}"

msgid " Press to jump to the right\n"
"                   time!"
msgstr " Cliquez pour sauter à la bonne\n"
"                   heure!"
...
msgid "Set week day"
msgstr "Définir le jour de la semaine"

msgid "{color=#00589E}Money:[money]----------------------{/color}"
msgstr "{couleur=#00589E} Argent:[money]----------------------{/couleur}"
...
msgid "Input money"
msgstr "Saisir le montant d'argent"

msgid "{color=#00589E}Gallery unlocker-----------------{/color}"
msgstr "{couleur=#00589E} Déverrouiller la galerie-----------------{/color}"

msgid "{color=#E60000}Add/Remove items{/color}"
msgstr "{couleur=#E60000} Ajouter/Supprimer des éléments{/color}"
...
msgstr "{couleur=#E60000} Jour de la semaine:{/color}"
...
msgstr "{couleur=#E60000} Changer les statistiques des filles{/couleur}"

msgid "Reset all girls anger lvl!"
msgstr "Réinitialiser le niveau de colère de toutes les filles!"

msgid "Set all girls libido lvl to max!"
msgstr "Mettez toutes les filles libido niv. max !"
...
msgstr "Augmenter la libido !"

msgid "Decrease libido!"
msgstr "Diminuer la libido !"

msgid "{color=#00589E}Submission:{/color} {color=#1DDB16}[momsubmission]{/color}"
msgstr "{color=#00589E}Soumission:{/color} {color=#1DDB16}[momsubmission]{/color}"

msgid "Increase submission!"
msgstr "Augmenter la soumission !"

msgid "Decrease submission!"
msgstr "Diminuer la soumission!"

msgid "{color=#00589E}Anger:{/color} {color=#1DDB16}[momanger]{/color}"
msgstr "{color=#00589E}Colère:{/color} {color=#1DDB16}[momanger]{/color}"

msgid "Reset anger!"
msgstr "Réinitialiser la colère !"

msgid "Increase anger!"
msgstr "Augmenter la colère!"

msgid "Decrease anger!"
msgstr "Diminuer la colère !"
...
msgstr "{color=#00589E}Respect:{/color} {color=#1DDB16}[laurenrespect]{/color}"

msgid "{color=#00589E}Affection:{/color} {color=#1DDB16}[laurenaffection]{/color}"
msgstr "{color=#00589E}Affection:{/color} {color=#1DDB16}[laurenaffection]{/color}"
...
msgstr "{color=#00589E}Soumission:{/color} {color=#1DDB16}[laurensubmission]{/color}"

msgid "{color=#00589E}Anger:{/color} {color=#1DDB16}[laurenanger]{/color}"
msgstr "{color=#00589E}Colère:{/color} {color=#1DDB16}[laurenanger]{/color}"

msgid "{color=#00589E}School influence:{/color} {color=#1DDB16}[school_influence]{/color}"
msgstr "{ color=#00589E}Influence à l'école:{ /color} { color=#1DDB16}[school_influence]{ /color }"

msgid "Increase influence!"
msgstr "Augmenter l'influence!"

msgid "Decrease influence!"
msgstr "Diminuer l’influence !"
...
msgstr "{color=#00589E}Respect:{/color} {color=#1DDB16}[sidneyrespect]{/color}"

msgid "{color=#00589E}Affection:{/color} {color=#1DDB16}[sidneyaffection]{/color}"
msgstr "{color=#00589E}Affection:{/color} {color=#1DDB16}[sidneyaffection]{/color}"
...
msgstr "{color=#00589E}Soumission:{/color} {color=#1DDB16}[sidneysubmission]{/color}"

msgid "{color=#00589E}Anger:{/color} {color=#1DDB16}[sidneyanger]{/color}"
msgstr "{color=#00589E}Colère:{/color} {color=#1DDB16}[sidneyanger]{/color}"
...
msgstr "{color=#00589E}Respect:{/color} {color=#1DDB16}[auntrespect]{/color}"

msgid "{color=#00589E}Affection:{/color} {color=#1DDB16}[auntaffection]{/color}"
msgstr "{color=#00589E}Affection:{/color} {color=#1DDB16}[auntaffection]{/color}"
...
msgstr "{color=#00589E}Soumission:{/color} {color=#1DDB16}[auntsubmission]{/color}"

msgid "{color=#00589E}Anger:{/color} {color=#1DDB16}[auntanger]{/color}"
msgstr "{color=#00589E}Colère:{/color} {color=#1DDB16}[auntanger]{/color}"

msgid "{color=#00589E}Respect:{/color} {color=#1DDB16}[cousinrespect]{/color}"
msgstr "{color=#00589E}Respect:{/color} {color=#1DDB16}[cousinrespect]{/color}"

msgid "{color=#00589E}Affection:{/color} {color=#1DDB16}[cousinaffection]{/color}"
msgstr "{color=#00589E}Affection:{/color} {color=#1DDB16}[cousinaffection]{/color}"
...
msgstr "{color=#00589E}Soumission:{/color} {color=#1DDB16}[cousinsubmission]{/color}"

msgid "{color=#00589E}Anger:{/color} {color=#1DDB16}[cousinanger]{/color}"
msgstr "{color=#00589E}Colère:{/color} {color=#1DDB16}[cousinanger]{/color}"

msgid "Do you want to change your name? Default name is: {color=#0000CC}Ryan{/color}"
msgstr "Voulez-vous changer votre nom? Le nom par défaut est : {color=#0000CC}Ryan{/color}"
