...
msgstr "[RT] {i}je devrais d’abord aller au portrait de famille pour me souvenir. {/i}"
...
msgstr "[RT] {i}je dois aller parler à l’oncle Bobby à l’entrepôt. Je peux m’y rendre en regardant le plan de la ville. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 2 avant de pouvoir commencer l’événement 3. {/i}"
...
msgstr "[RT] {i}je dois aller chez moi et parler à maman. Elle devrait être dans la cuisine. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 3 avant de pouvoir commencer l’événement 4. {/i}"
...
msgstr "[RT] {i}Je pense que maman est probablement assez remuée. Je devrais aller la voir dans sa chambre. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir commencer l’événement 5. {/i}"
...
msgstr "[RT] {i}Lauren aime traîner dans le salon le soir. Peut-être que je devrais aller la voir. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 5 avant de pouvoir commencer l’événement 6. {/i}"
...
msgstr "[RT] {i}je devrais aller à la cuisine le soir pour le dîner en famille. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir commencer l’événement 7. {/i}"
...
msgstr "[RT] {i}je dois aller à l’école en fin de matinée ou l'après-midi. {/i}"
...
msgstr "[RT] {i}je dois visiter le premier box dans les toilettes de l’école dans l’après-midi. {/i}"
...
msgstr "[RT] {i}Bizarre.... Je ne peux pas terminer cet événement avant d’avoir terminé l’événement 27.... Ça doit être parce que j’ai dit à Matt que je ne voulais pas qu’il m’aide à séduire maman. {/i}"
...
msgstr "[RT] {i}je dois aller à l’école et traîner dans le couloir en fin de matinée. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir commencer l’événement 8. {/i}"
...
msgstr "[RT] {i}maman travaille très dur toute la semaine. Je devrais l’aider avec du travail autour de la maison les matins du week-end. Elle commence généralement à nettoyer dans le salon. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 6 avant de pouvoir commencer l’événement 9. {/i}"
...
msgstr "[RT] {i}je dois me faufiler dans la chambre de Lauren la nuit et voir si je peux utiliser des messages subliminaux sur les filles. {/i}"
...
msgstr "[RT] {i}j’ai besoin d’acheter de la mélatonine dans la boutique en ligne sur mon ordinateur portable dans ma chambre et de le verser dans le thé dans la cuisine. {/i}"
...
msgstr "[RT] {i}Les filles devraient dormir plus profondément la nuit. Je devrais aller leur rendre une autre visite. {/i}"
...
msgstr "[RT] {i}je dois continuer à me faufiler dans la chambre des filles la nuit jusqu’à ce que je termine cet événement. {/i}"
...
msgstr "[RT] {i}je devrais continuer à aller voir Sidney tôt le matin pour terminer cet événement. {/i}"
...
msgstr "[RT] {i}je devrais aller voir Sidney tôt le matin dans le salon et voir si elle a besoin d’une présence pour la course. {/i}"
...
msgstr "[RT] {i}je devrais voir si je peux effrayer Sidney dans le salon la nuit. {/i}"
...
msgstr "[RT] {i}Je dois terminer l'événement 9 avant de pouvoir commencer l'événement 10 {/i}"
...
msgstr "[RT] {i}je devrais aller dormir et parler à Lauren et à la cousine Mandy le matin. {/i}"
...
msgstr "[RT] {i}je devrais continuer à visiter la cuisine le soir jusqu’à ce que Sidney en ait fini avec les costumes de cosplay. {/i}"
...
msgstr "[RT] {i}Je dois rendre visite à Sidney dans la soirée et commander une tenue cosplay pour Lauren.{/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 11. {/i}"
...
msgstr "[RT] {i}je dois continuer à murmurer des messages subliminaux à l’oreille de maman la nuit. {/i}"
...
msgstr "[RT] {i}je devrais aller prendre le petit déjeuner avec ma famille tôt le matin et voir si maman porte son peignoir. {/i}"
...
msgstr "[RT] {i}je me demande ce qu’elle porterait si le peignoir disparaissait soudainement. {/i}"
...
msgstr "[RT] {i}j’ai besoin de trouver et de cacher le peignoir de maman. L’endroit le plus probable serait dans sa chambre. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 12 avant de pouvoir commencer à travailler sur cet événement. {/i}"

# game/Phone_event_screen.rpy:973 ## translate crowdin event_info_13_0c499352:
msgid "[RT] {i}I should keep visiting Mom at night.{/i}"
msgstr "[RT] {i}je devrais continuer à rendre visite à maman la nuit. {/i}"
...
msgstr "[RT] {i}je dois continuer à murmurer des messages subliminaux à l’oreille de Lauren la nuit. {/i}"
...
msgstr "[RT] {i}je devrais continuer à rendre visite à Lauren la nuit. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir commencer l’événement 15. {/i}"
...
msgstr "[RT] {i}Si je ne paie pas la mafia pendant plus de 3 semaines d'affilée, je pourrais terminer cet événement NTR{/i}"
...
msgstr "[RT] {i}Quand maman va au club, j’ai besoin d’aller la voir pour voir comment elle fait les choses. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 8 avant de pouvoir commencer l’événement 16. {/i}"
...
msgstr "[RT] {i}j’ai besoin d’amener maman à se détendre un peu plus. Peut-être que je peux la corrompre avec notre devoir d’Œdipe à l’école. {/i}"

# game/Phone_event_screen.rpy:1005 ## translate crowdin event_info_16_fb2fbedc:
msgid "[RT] {i}Mom works really hard all week. I should help her with jobs around the house on weekend mornings. She usually starts cleaning in the lounge.{/i}"
msgstr "[RT] {i}maman travaille très dur toute la semaine. Je devrais l’aider avec les travaux autour de la maison les matins du week-end. Elle commence généralement à nettoyer dans le salon. {/i}"
...
msgstr "[RT] {i}j’ai placé la caméra espion dans la salle de bain. Maintenant, j’ai juste besoin de surprendre maman quand sa libido est à son plus haut (10 pts). {/i}"
...
msgstr "[RT] {i}je dois acheter une caméra espion et la placer dans la salle de bain quand personne n’est là. {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 17. {/i}"
...
msgstr "[RT] {i}j’ai placé la caméra espion dans la chambre de maman. Maintenant, j’ai juste besoin de surprendre maman quand sa libido est à son plus haut (10 pts). {/i}"
...
msgstr "[RT] {i}je dois acheter une caméra espion et la placer dans la chambre de maman quand personne n’est là. {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 18. {/i}"
...
msgstr "[RT] {i}j’ai placé la caméra espion dans la salle de bain. Maintenant, j’ai juste besoin de surprendre Lauren quand sa libido est à son plus haut (10 pts). {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 19. {/i}"
...
msgstr "[RT] {i}j’ai placé la caméra espion dans la chambre de Lauren. Maintenant, j’ai juste besoin de surprendre Lauren quand sa libido est à son plus haut (10 pts). {/i}"
...
msgstr "[RT] {i}je dois acheter une caméra espion et la placer dans la chambre de Lauren quand personne n’est là. {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 20. {/i}"
...
msgstr "[RT] {i}j’ai placé la caméra espion dans la salle de bain. Maintenant, j’ai juste besoin de surprendre Sidney quand sa libido est à son plus haut (10 pts). {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 21. {/i}"
...
msgstr "[RT] {i}j’ai placé la caméra espion dans la chambre de Lauren. Maintenant, j’ai juste besoin de surprendre Sindney quand sa libido est à son plus haut (10 pts). {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 8 avant de pouvoir commencer à travailler sur l’événement 22. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir commencer l’événement 23. {/i}"
...
msgstr "[RT] {i}je dois garder maman hors du club en payant la dette de la mafia pendant plus de 3 semaines d’affilée. {/i}"
...
msgstr "[RT] {i}j’ai reçu une pub par e-mail sur mon téléphone pour un bikini. Je ferais mieux de l’acheter dès que je peux juste au cas où j’en aurais besoin avant le week-end suivant. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 23 avant de pouvoir commencer l’événement 24. {/i}"
...
msgstr "[RT] {i}j’ai le bikini maintenant. Je serais intelligent de m’assurer que la libido et la soumission de maman sont aussi élevées que possible, alors peut-être que je peux lui demander d’essayer le maillot de bain pour moi. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir commencer l’événement 25. {/i}"
...
msgstr "[RT] {i}je dois garder maman hors du club en payant la dette de la mafia pendant plus de 3 semaines d’affilée. Peut-être qu'elle me récompensera avec un tête-à-tête. {/i}"
...
msgstr "[RT] {i}je devrais continuer à vérifier la cuisine pour voir quand Sidney en aura fini avec la tenue de cosplay de Lauren. {/i}"
...
msgstr "[RT] {i}je devrais aller parler à Sidney de la commande d’une autre tenue de cosplay. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 11 avant de pouvoir commencer à travailler sur l’événement 26. {/i}"
...
msgstr "[RT] {i}Je dois terminer l'événement 26 avant de pouvoir commencer l'événement 27 {/i}"
...
msgstr "[RT] {i}je dois aller à l’entrepôt en fin de matinée pour prendre des photos avec Lauren. {/i}"
...
msgstr "[RT] {i}Je dois terminer l'événement 27 avant de pouvoir commencer l'événement 28 {/i}"
...
msgstr "[RT] {i}je dois continuer à prendre ces photos «Dragon» avec Lauren jusqu’à ce que nous ayons toutes les sortes de photos dont nous avons besoin. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 27 avant de pouvoir terminer l’événement 29. {/i}"
...
msgstr "[RT] {i}j’ai un visiteur qui vient jeudi matin, mais je ne le sais pas encore. Je dois rembourser le visiteur lorsque l’option m’est donnée. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 27 avant de pouvoir terminer l’événement 30. {/i}"
...
msgstr "[RT] {i}j’ai un visiteur qui vient jeudi matin, mais je ne le sais pas encore. Je dois refuser de le payer quand on me donne l’option.{/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 28 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je devrais regarder la télévision avec Lauren dans le salon. Peut-être que plus elle regardera «Game of Thots», plus elle sera ouverte à déconner un peu.{/i}"
...
msgstr "[RT] {i}j’ai entendu dire que l’école allait recommencer à faire des annonces matinales tous les lundis. Ils se sont arrêtés lorsque les officiers du corps étudiant sont partis pour New York lors de leur voyage à l'ONU.{/i}"
...
msgstr "[RT] {i}j’ai entendu dire qu’ils ont une annonce excitante pour commencer. Je ferais mieux de m’assurer que je suis dans {b}la classe de maman tous les lundis matin{/b} pour ne pas manquer les annonces. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 31 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}j’ai une excellente idée pour aider Lauren à gagner des votes. Je dois continuer à essayer de la convaincre jusqu’à ce qu’elle accepte. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 4 avant de pouvoir terminer l’événement 33. {/i}"
...
msgstr "[RT] {i}je dois assister au cours jusqu’à ce que j’aie la possibilité de «parler à maman du devoir d’Œdipe». {/i}"
...
msgstr "[RT] {i}je dois continuer à «parler à maman de l’affectation d’Œdipe» dans son bureau jusqu’à ce que j’aie la possibilité voir Matt et Megan. {/i}"
...
msgstr "[RT] {i}Une fois que j’ai cette option, je dois regarder dans le vestiaire des filles. {/i}"
...
msgstr "[RT] {i}je dois terminer la majeure partie de l’événement 33 avant de terminer l’événement 34. {/i}"
...
msgstr "[RT] {i}j’ai juste besoin de choisir de résister à l’envie de jeter un coup d’œil, au lieu de voir Matt et Megan. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 32 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}Après nos réunions de campagne de l’après-midi dans les toilettes des filles, j’ai la possibilité d’aller voir Mme Stone. {p}Elle peut m’aider à faire des affiches de kick-ass. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 16 avant de pouvoir terminer l’événement 36. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 34 avant de pouvoir terminer 36. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 28 ou l’événement 29 pour commencer à travailler sur cet événement. {/i}"
...
msgstr "[RT] {i}je dois continuer à rendre visite à Lauren dans le salon pendant la soirée pour voir tout ce qu’elle fera pour moi. {/i}"
...
msgstr "[RT] {i} je dois terminer l’événement 27 pour commencer à travailler sur l’événement 38.{/i}"
...
msgstr "[RT] {i}je devrais voir si je peux pousser Sidney plus loin quand nous dormons ensemble la nuit. {/i}"
...
msgstr "[RT] {i}je dois continuer à vérifier la cuisine pendant les soirées pour voir si Sidney en a fini avec sa tenue. {/i}"
...
msgstr "[RT] {i}je dois visiter le studio photo de l’entrepôt pendant l’après-midi. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 35 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 29 ou 30 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}J'ai besoin de rencontrer l'équipe de campagne dans les toilettes des filles dans l'après-midi. Lauren va surement trouver de bonnes stratégies. {/i}"
...
msgstr "[RT] {i}Nous avons décidé qu’il serait bon de rendre visite à Diaz et de voir si elle peut déterrer de la saleté sur Matt. Je peux probablement trouver sa camionnette sur ma carte un soir de semaine. {/i}"
...
msgstr "[RT] {i}je dois mettre une caméra espion dans le vestiaire des filles. Il serait probablement préférable d’y aller tôt le matin avant qu’il n’y ait beaucoup de monde. {/i}"
...
msgstr "[RT] {i}je dois continuer à prendre ces photos de « Womb Raider » avec Sidney jusqu’à ce que nous ayons toutes les sortes de photos dont nous avons besoin. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 38 pour commencer à travailler sur l’événement 40. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 40 pour commencer à travailler sur l’événement 41. {/i}"
...
msgstr "[RT] {i}je dois avoir la visite de Sidney dans mon lit ce soir. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 39 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois continuer à rendre visite à Diaz dans sa camionnette jusqu’à ce que je termine cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 31 avant de pouvoir commencer cet événement NTR. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 37 avant de pouvoir terminer cet événement NTR. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 34 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}même chose tous les week-ends. Payer la mafia, embrasser maman, avoir la trique et la jeter par terre. {/i}"
...
msgstr "[RT] {i}J’espère que quelque chose sera différent la prochaine fois que je paierai la dette à la mafia. {/i}"
...
msgstr "[RT] {i}je dois continuer à rendre visite à maman dans son bureau à l’école. {/i}"
...
msgstr "[RT] {i}je dois terminer les événements 7, 40 et 44 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je devrais commencer le shooting photos avec maman et Megan en allant à l’entrepôt un soir de semaine. {/i}"
...
msgstr "[RT] {i}j’ai besoin d’obtenir un ball gag quelque part. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 45 avant de pouvoir commencer à travailler sur cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 46 avant de pouvoir commencer à travailler sur cet événement. {/i}"
...
msgstr "[RT] {i}je devrais continuer à soumettre de maman en la poussant à faire de nouvelles choses lors de la séance photo. {/i}"
...
msgstr "[RT] {i}je dois terminer les événements 10 et 40 avant de pouvoir commencer à travailler sur l’événement 48. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 40 avant de pouvoir commencer à travailler sur l’événement 48. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 10 avant de pouvoir commencer à travailler sur l’événement 48. {/i}"
...
msgstr "[RT] {i}je dois continuer à aller voir Sidney tôt le matin dans le parc pour terminer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 40 avant de pouvoir commencer à travailler sur cet événement. {/i}"
...
msgstr "[RT] {i}Sidney était drôle quand je lui ai parlé de maman. Je ferais mieux de garder un œil sur elle ce week-end lorsque la mafia viendra pour le paiement hebdomadaire. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 48 avant de pouvoir commencer à travailler sur cet événement. {/i}"
...
msgstr "[RT] {i}j’ai besoin de rendre visite à Sidney pendant qu’elle travaille au club, peut-être qu’elle aura un peu plus de temps pour s’amuser un peu plus. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 11 avant de pouvoir commencer à travailler sur l’événement 51. {/i}"
...
msgstr "[RT] {i}je parie que tante Camille sera en colère contre les photos que j’ai prises de la cousine Mandy. Je devrais juste attendre sa visite. {/i}"
...
msgstr "[RT] {i}J'ai entendu la rumeur selon laquelle il y a eu des pressions exercées sur Oncle Bobby Je me demande si je vais avoir de ses nouvelles bientôt.{/i}"
...
msgstr "[RT] {i}je me demande de quoi parlait ce texte. Je devrais aller à l’entrepôt pour voir si l’oncle Bobby va bien. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 51 avant de pouvoir commencer à travailler sur l’événement 52. {/i}"
...
msgstr "[RT] {i}je devrais continuer à rendre visite à Sidney le soir jusqu’à ce que tante Camille vienne lui rendre visite à nouveau. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 52 avant de pouvoir commencer à travailler sur l’événement 53. {/i}"
...
msgstr "[RT] {i}je devrais continuer à visiter le salon en fin de matinée jusqu’à ce que je revoie tante Cami. {/i}"
...
msgstr "[RT] {i}je devrais continuer à aller à la cuisine en fin de matinée jusqu’à ce que je puisse assigner à tante Camille une corvée pour la faire travailler. {/i}"
...
msgstr "[RT] {i}j’ai besoin de développer la libido ou la soumission de tante Camille afin de pouvoir lui faire quelque chose d’encore plus vicieux dans la salle de bain. {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 53 avant de pouvoir commencer à travailler sur l’événement 54. {/i}"
...
msgstr "[RT] {i}je dois développer la libido ou la soumission de tante Camille afin de pouvoir conclure un accord avec elle dans le salon. {/i}"
...
msgstr "[RT] {i}je dois commencer à travailler sur l’événement 53 avant de pouvoir commencer à travailler sur l’événement 55. {/i}"
...
msgstr "[RT] {i}j’ai besoin de développer la libido ou la soumission de tante Camille afin de pouvoir conclure un accord avec elle dans la cuisine. {/i}"
...
msgstr "[RT] {i}je dois également terminer l’événement 41. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 41 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}j’ai un sentiment étrange que quelque chose de bizarre est sur le point de m’arriver. Peut-être que le sentiment disparaîtra quand je m’endormirais ce soir. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 48 avant de pouvoir commencer l’événement 56. {/i}"
...
msgstr "[RT] {i}je dois aller voir Sidney tôt le matin et essayer tout ce qu’elle a à offrir au parc. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 13 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 14 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 29 et ou 30 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 53 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}Maintenant, j’ai juste besoin d’attendre que quelque chose se passe tôt dimanche matin. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 57 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 58 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois rendre visite à Sidney au club et choisir toutes les options. {/i}"
...
msgstr "[RT] {i}je dois rendre visite à Sidney au club lundi soir. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 59 avant de pouvoir terminer cet événement. {/i}"
...
msgstr "[RT] {i}Mme Stone est à la hauteur pour presque tout... Je me demande jusqu'où elle ira si je ne cesse de lui rendre visite chaque semaine. {/i}"
...
msgstr "[RT] {i}je pense que j’ai entendu Mandy regarder la télévision dans le salon avec Lauren le soir. Je devrais y aller. {/i}"
...
msgstr "[RT] {i}je devrais parler à Megan en classe de ce que Diaz a enregistré dans le vestiaire. {/i}"
...
msgstr "[RT] {i}Mandy se douche toujours avec Lauren, comment vais-je la surprendre en train de se masturber sous la douche ? {/i}"
...
msgstr "[RT] {i}Attendez! Elle ne se douche pas seul le dimanche?... Si je visite la salle de bain quand sa libido est au max...{/i}"
...
msgstr "[RT] {i}Mandy est toujours seule dans sa chambre le soir. Je me demande ce que je vais voir si sa libido est au max. {/i}"
...
msgstr "[RT] {i}tante Camilleprend toujours une douche l’après-midi, je me demande ce que je vais voir si je l’espionne quand sa libido est au max. {/i}"
...
msgstr "[RT] {i}tante Camille est toujours seule dans la chambre de maman le soir. Je me demande ce que je vais voir si sa libido est au max. {/i}"
...
msgstr "[RT] {i}je devrais juste continuer à visiter la chambre de Lauren la nuit. Je veux voir où cela mènera. {/i}"
...
msgstr "[RT] {i}je dois garder Lauren heureuse en l’aidant à faire le meilleur possible dans les sondages. Je dois également terminer l’événement 66 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois garder Lauren heureuse en l’aidant à faire le meilleur possible dans les sondages. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 67 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}Avec la cousine Mandy dans la chambre de Lauren, les visites de l’agent Diaz pourraient devenir intéressantes. Je devrais quand même m’assurer de payer pour les garder en sécurité. {/i}"
...
msgstr "[RT] {i}Avec la cousine Mandy dans la chambre de Lauren, les visites de l’agent Diaz pourraient devenir intéressantes. Que se passerait-il si je ne le remboursais pas? {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 42 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 62 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}je dois continuer à aller aux réunions de campagne de Lauren l’après-midi dans les toilettes. Elle a forcément une idée derrière la tête. {/i}"
...
msgstr "[RT] {i}je dois rendre visite à Will Tylor, membre du conseil scolaire. Je peux probablement trouver son bureau sur ma carte en fin de matinée ou dans l'après-midi. {/i}"
...
msgstr "[RT] {i}Will Tylor veut un putain de rendez-vous avec ma mère?... Devrais-je l’aider?... Changer le code vestimentaire garantirait presque que Lauren gagnerait. {/i}"
...
msgstr "[RT] {i}je devrais convaincre maman d’aller dîner avec lui cependant... Je ne sais pas si elle le ferait. Je pense qu’elle le déteste... Je pourrais lui demander au petit déjeuner. Elle semble être de meilleure humeur le matin. {/i}"
...
msgstr "[RT] {i}j’ai envoyé à Will un e-mail lui faisant savoir que ma mère est prête à le rencontrer pour le dîner. Maintenant, je n’ai plus qu’à attendre sa réponse. Je suis sûr que cela ne prendra pas plus d’une semaine. Je parie qu’il l’enverra samedi quand il aura un peu plus de temps. {/i}"
...
msgstr "[RT] {i}Après ce que Sidney et moi avons fait au club, je me demande si elle sera prête à aller plus loin au parc. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 59 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}Après ce que Sidney et moi avons fait dans le club, je me demande si elle sera prête à aller plus loin dans la chambre. {/i}"
...
msgstr "[RT] {i}Après ce que Sidney et moi avons fait dans le club, je me demande si elle sera prête à aller plus loin après une séance photo. {/i}"
...
msgstr "[RT] {i}Après ce que Sidney et moi avons fait dans le club, je me demande si elle sera prête à continuer à le faire là-bas. {/i}"
...
msgstr "[RT] {i}Plus j’ai d’événements et d’influence scolaire, meilleur est le résultat de l’élection. {p}L’élection débutera un vendredi. J’ai juste besoin d’être en classe quand ça commence. {/i}"
...
msgstr "[RT] {i}je ferais mieux de m’assurer que j’ai déjà terminé toutes mes tâches... Je ne pourrais pas les faire après les élections. {/i}"
...
msgstr "[RT] {i}je dois terminer l’événement 76 avant de pouvoir commencer cet événement. {/i}"
...
msgstr "[RT] {i}Maintenant que Lauren est la présidente des étudiants, elle peut lire les annonces du matin. Je devrais en écouter quelques-unes le lundi matin. {/i}"
...
msgstr "[RT] {i}je parie que je peux aller encore plus loin avec Lauren quand on regarde la télé le soir. {/i}"
...
msgstr "[RT] {i}Je pense que Lauren et moi nous sentons tous les deux très excités après une séance photo. Je me demande si je peux pousser les choses plus loin après notre prochaine séance photo. {/i}"
...
msgstr "[RT] {i}je parie que je pourrais baiser avec Lauren l’éleveuse de dragons après notre prochaine séance photo. {/i}"
...
msgstr "[RT] {i}Avec autant de monde dans la maison, il est difficile d’attraper Lauren seule... Elle prend habituellement sa douche seule tôt le samedi. Cela pourrait être une bonne occasion de s’amuser davantage. {/i}"
...
msgstr "[R] Test.... Test .... Ok .... Ça ressemble à un enregistrement."
...
msgstr "[R] Je m’appelle [ryan].... Et si vous regardez cet enregistrement, cela signifie que je suis mort."
...
msgstr "[R] Ou je suppose que cela pourrait signifier le scénario extrêmement improbable, que mon ordinateur a été piraté, et maintenant un imbécile utilise mon histoire pour gagner de l'argent."
...
msgstr "[R] Parce que la série d’événements dont je vais vous parler est tellement incroyable qu’elle ferait un grand film ou une série télévisée."
...
msgstr "[WT] Revenons à vous [ryan]."
...
msgstr "[R] je voulais enregistrer ma version des événements qui se sont produits au cours de ces derniers temps."
...
msgstr "[WT] C'est un exemple typique de l'écran du jeu. Comme le mentionne [ryan] , vous acquérez de nombreux articles dans le jeu."
...
msgstr "[WT] pendant que ce symbole vous indique l’heure de la journée."
...
msgstr "[WT] Sur la carte du jeu, vous pouvez vous déplacer à de nombreux endroits en utilisant les boutons de déplacement."
...
msgstr "[WT] Ce bouton ici ouvrira une carte de la maison, où vous pourrez choisir n’importe quelle pièce où vous souhaitez aller."
...
msgstr "[R] Le fait d’avoir toujours à surveiller mes arrières m’a rapproché des quelques personnes en qui je peux avoir confiance."
...
msgstr "[M] Eh bien, d’accord.... Mais tu sais, tu n’as pas besoin de te soulager tout seul, non?"
...
msgstr "[M] Tu sais, que si tu as besoin d’un peu de soulagement, tu as juste besoin de me le faire savoir. Et si je suis trop occupée, je suis sûre que tes sœurs seraient heureuses de t'aider."
...
msgstr "[R] S’il vous plaît, ne me jugez pas tant que vous n’avez pas entendu ma version de l’histoire."
...
msgstr "[R] C'est comme je l'ai dit... Avec autant de personnages, en suivant mes mouvements, j'avais besoin de me rapprocher des gens autour de moi."
...
msgstr "[WT] Il est donc très important que vous gardiez une trace de ces statistiques."
...
msgstr "[WT] L’emoji en colère représente une colère de la fille envers vous. Il est difficile de les amener à faire quoi que ce soit pour vous quand elle est en colère."
...
msgstr "[WT] Cette icône de fouet représente une soumission de la fille pour vous."
...
msgstr "[WT] Et ces lèvres représentent la libido de la fille."
...
msgstr "[WT] Une fois que votre téléphone est tiré vers le haut, vous pouvez suivre les statistiques d’une fille,"
...
msgstr "[WT] Voilà donc tous les conseils que nous avons pour vous. Tout le reste que vous devrez comprendre par vous-même, ou je suppose que vous pouvez toujours trouver la procédure pas à pas (walkthrough), ou demander de l’aide en ligne."
...
msgstr "[WT] Allez-y et reprenez à partir d’ici [ryan]!"
...
msgstr "[R] Je suppose que la meilleure chose que je puisse faire, c'est de vous raconter mon histoire et de laisser quiconque être juge de mes actions."
...
msgstr "[R] Et encore une fois, j’espère que cette histoire se transformera en une série HBO kick ass, et non en un putain de jeu hantai foireux."
...
msgstr "[R] Jusqu’à ce que je sois réveillé très tôt un jour, par un appel téléphonique qui allait changer ma vie pour toujours...."
