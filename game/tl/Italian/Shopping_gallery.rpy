...
translate crowdin strings:
    ...
    new "Acquista schermo verde."

    # game/Shopping_gallery.rpy:435
    old "Buy pro lights."
    new "Compra luci professionali."

    # game/Shopping_gallery.rpy:453
    old "Buy DSLR camera."
    new "Acquista fotocamera DSLR."

    # game/Shopping_gallery.rpy:470
    old "Buy camera accessory."
    new "Acquista l'accessorio della fotocamera."
