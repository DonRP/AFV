...
msgstr "[RT] {i}Dovrei andare prima al ritratto della famiglia per ricordare.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare a parlare con lo zio Bobby al magazzino. Posso arrivare lì guardando la mappa della città.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 2 prima di poter anche iniziare l'evento 3.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare a casa mia e parlare con la mamma. Dovrebbe essere in cucina.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 3 prima di poter anche iniziare l'evento 4.{/i}"
...
msgstr "[RT] {i}Penso che probabilmente la mamma sia piuttosto scossa. Dovrei andare a controllarla nella sua stanza.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter anche iniziare l'evento 5.{/i}"
...
msgstr "[RT] {i}Lauren ama uscire in salotto la sera. Forse dovrei andare a vederla.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 5 prima di poter anche iniziare l'evento 6.{/i}"
...
msgstr "[RT] {i}Dovrei andare in cucina la sera per la cena in famiglia.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter anche iniziare l'evento 7.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare a scuola nel tardo mattino o pomeriggio.{/i}"
...
msgstr "[RT] {i}Ho bisogno di visitare la prima bancarella nel bagno della scuola nel pomeriggio.{/i}"
...
msgstr "[RT] {i}Strano... Non posso finire questo evento fino a quando non finirò l'evento 27... Deve essere perché ho detto a Matt che non volevo il suo aiuto sedurre la mamma.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare a scuola e uscire nel corridoio alla tarda mattina.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter anche iniziare l'evento 8.{/i}"
...
msgstr "[RT] {i}Mamma lavora davvero duramente per tutta la settimana. Dovrei aiutarla con i lavori intorno a casa il fine settimana mattina. Di solito inizia a pulire nel salone.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 6 prima di poter anche iniziare l'evento 9.{/i}"
...
msgstr "[RT] {i}Ho bisogno di entrare nella stanza di Lauren di notte e vedere se posso usare i messaggi subliminali sulle ragazze.{/i}"
...
msgstr "[RT] {i}Ho bisogno di acquistare un po 'di melatonina dal negozio online sul mio computer portatile nella mia camera da letto e picchiare il tè in cucina.{/i}"
...
msgstr "[RT] {i}Le ragazze dovrebbero dormire più a fondo la notte. Dovrei andare a pagare un'altra visita.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare ad entrare nella stanza delle ragazze di notte fino a quando non ho completato questo evento.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a correre con Sidney durante la mattina presto per completare questo evento.{/i}"
...
msgstr "[RT] {i}Dovrei andare a vedere Sidney la mattina presto nella lounge e vedere se ha bisogno di un amico in corso.{/i}"
...
msgstr "[RT] {i}Dovrei vedere se posso spaventare Sidney nella lounge di notte.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 9 prima di poter iniziare l'evento 10.{/i}"
...
msgstr "[RT] {i}Dovrei andare a dormire e parlare con Lauren e Cousin Mandy al mattino.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a visitare la cucina la sera fino a quando Sidney sarà fatto con i costumi cosplay.{/i}"
...
msgstr "[RT] {i}Ho bisogno di visitare Sidney la sera e commissionare un outfit cosplay per Lauren.{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 11.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a sussurrare i messaggi subliminali nell'orecchio di mamma di notte.{/i}"
...
msgstr "[RT] {i}Dovrei fare colazione con la mia famiglia la mattina presto e vedere se la mamma indossa il suo accappatoio.{/i}"
...
msgstr "[RT] {i}Mi chiedo cosa indosserebbe se l'accappatoio dovesse improvvisamente dissaporire.{/i}"
...
msgstr "[RT] {i}Ho bisogno di trovare e nascondere l'accappatoio della mamma. Molto probabilmente il posto sarebbe nella sua stanza.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 12 prima di poter iniziare l'evento.{/i}"

# game/Phone_event_screen.rpy:973 ## translate crowdin event_info_13_0c499352:
msgid "[RT] {i}I should keep visiting Mom at night.{/i}"
msgstr "[RT] {i}Dovrei continuare a visitare la mamma di notte.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a sussurrare messaggi subliminali nell'orecchio di Lauren di notte.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a visitare Lauren di notte.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter iniziare l'evento 15.{/i}"
...
msgstr "[RT] {i}Se non pago la mafia per più di 3 settimane consecutive, potrei solo completare questo evento NTR.{/i}"
...
msgstr "[RT] {i}Quando la mamma va al club, devo andare a controllarla per vedere come sta facendo.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 8 prima di poter iniziare l'evento 16.{/i}"
...
msgstr "[RT] {i}Ho bisogno di ottenere la mamma per sciogliere un po 'di più. Forse posso corrompere lei con il nostro incarico Oedipus a scuola.{/i}"
...
msgstr "[RT] {i}Ho piazzato lo spycam in bagno. Ora ho solo bisogno di catturare la mamma lì quando la sua libido è più alta (10 pts).{/i}"
...
msgstr "[RT] {i}Ho bisogno di comprare una spy-cam e metterla in bagno quando nessuno è in giro.{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 17.{/i}"
...
msgstr "[RT] {i}Ho piazzato lo spycam nella camera da letto della mamma. Ora ho solo bisogno di catturare la mamma lì quando la sua libido è più alta (10 pts).{/i}"
...
msgstr "[RT] {i}Ho bisogno di comprare una spy-cam e posizionarla nella camera da letto della mamma quando nessuno è in giro.{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 18.{/i}"
...
msgstr "[RT] {i}Ho piazzato lo spycam in bagno. Ora ho solo bisogno di catturare Lauren lì quando la sua libido è al massimo (10 pts).{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 19.{/i}"
...
msgstr "[RT] {i}Ho piazzato lo spycam nella camera da letto di Lauren. Ora ho solo bisogno di catturare Lauren lì quando la sua libido è al massimo (10 pts).{/i}"
...
msgstr "[RT] {i}Ho bisogno di comprare una spy-cam e posizionarla nella camera da letto di Lauren quando nessuno è in giro.{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 20.{/i}"
...
msgstr "[RT] {i}Ho piazzato lo spycam in bagno. Ora ho solo bisogno di prendere Sidney in là quando la sua libido è al massimo (10 pts).{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 21.{/i}"
...
msgstr "[RT] {i}Ho piazzato lo spycam nella camera da letto di Lauren. Ora ho solo bisogno di prendere Sidney in là quando la sua libido è al massimo (10 pts).{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 8 prima di poter iniziare a lavorare all'evento 22.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter iniziare l'evento 23.{/i}"
...
msgstr "[RT] {i}Ho bisogno di tenere la mamma fuori dal club pagando il debito mafioso per più di 3 settimane di fila.{/i}"
...
msgstr "[RT] {i}Ho ricevuto un annuncio email sul mio telefono per un bikini. Meglio comprarlo non appena posso solo nel caso in cui ho bisogno prima del prossimo fine settimana.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 23 prima di poter iniziare l'evento 24.{/i}"
...
msgstr "[RT] {i}Ho il bikini adesso. Sarei intelligente per assicurarsi che la libido e la sottomissione di mamma siano il più alto possibile, allora forse posso chiederle di provare il costume da bagno per me. /i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter iniziare l'evento 25.{/i}"
...
msgstr "[RT] {i}Ho bisogno di tenere la mamma fuori dal club pagando il debito mafioso per più di 3 settimane di fila. Forse lei mi ricompenserà con qualche one-on-one volta.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a controllare la cucina per vedere quando Sidney sarà fatto con l'abbigliamento cosplay di Lauren.{/i}"
...
msgstr "[RT] {i}Dovrei andare a parlare con Sidney per commissionare un altro outfit di cosplay.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 11 prima di poter iniziare a lavorare sull'evento 26.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 26 prima di poter iniziare l'evento 27.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare al magazzino alla tarda mattina per scattare foto con Lauren.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 27 prima di poter iniziare l'evento 28.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a scattare queste foto \"Come Allevare il tuo Drago\" con Lauren fino a quando non avremo ogni tipo di foto di cui abbiamo bisogno.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 27 prima di poter completare l'evento 29.{/i}"
...
msgstr "[RT] {i}Ho un visitatore in arrivo il giovedì mattina, ma non lo so ancora. Ho bisogno di pagare il visitatore quando ho dato l'opzione.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 27 prima di poter completare l'evento 30.{/i}"
...
msgstr "[RT] {i}Ho un visitatore in arrivo il giovedì mattina, ma non lo so ancora. Devo rifiutarmi di pagarli quando mi viene data l'opzione.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 28 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Dovrei guardare un po' di tv con Lauren nella Lounge. Forse più guarda \"Game of Thots\", più sarà aperta a mettersi in giro un po'.{/i}"
...
msgstr "[RT] {i}Ho sentito che la scuola inizierà a fare annunci mattutini ogni lunedì di nuovo. Si sono fermati quando gli ufficiali del corpo studentesco partirono per New York durante il loro viaggio delle Nazioni Unite.{/i}"
...
msgstr "[RT] {i}Ho sentito che hanno un annuncio emozionante per iniziarlo. Farò meglio ad assicurarmi di essere in {b}lezioni di mamma ogni lunedì mattina{/b} quindi non perdo gli annunci.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 31 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho una grande idea per aiutare Lauren a vincere i voti. Devo continuare a cercare di convincerla finché non è d'accordo.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 4 prima di poter completare l'evento 33.{/i}"
...
msgstr "[RT] {i}Ho bisogno di frequentare la lezione fino a quando non ho l'opzione di \"Parlare con la mamma sull'assegnazione di Oedipus\".{/i}"
...
msgstr "[RT] {i}Ho bisogno di mantenere \"Parlando con la mamma circa l'assegnazione di Oedipus\" nel suo ufficio fino a quando non ho la possibilità di cercare Matt e Megan. /i}"
...
msgstr "[RT] {i}Una volta che ho questa opzione, devo guardare nello spogliatoio delle ragazze.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare la maggior parte dell'evento 33 prima di completare l'evento 34.{/i}"
...
msgstr "[RT] {i}Ho solo bisogno di scegliere di resistere alla voglia di sbirciare, invece di cercare Matt e Megan.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 32 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Dopo i nostri incontri di campagna pomeridiani nel bagno delle ragazze, ho la possibilità di andare a vedere la signora Pietra. {p}Lei può aiutarmi a fare alcuni poster di kick-ass.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 16 prima di completare l'evento 36.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 34 prima di poter completare 36.{/i}"
...
msgstr "[RT] {i}Devo completare l'evento 28 o l'evento 29 per iniziare a lavorare a questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a visitare Lauren nella lounge durante la sera per vedere quanto farà per me.{/i}"
...
msgstr "[RT] {i} Ho bisogno di completare l'evento 27 per iniziare a lavorare all'evento 38.{/i}"
...
msgstr "[RT] {i}Dovrei vedere se posso spingere Sidney più lontano quando dormiamo insieme di notte.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a controllare la cucina durante le serate per vedere se Sidney è fatto con il suo outfit.{/i}"
...
msgstr "[RT] {i}Ho bisogno di visitare lo studio fotografico al magazzino durante il pomeriggio.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 35 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 29 o 30 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a incontrare la squadra della campagna nel bagno delle ragazze nel pomeriggio. Lauren è sicuro di trovare alcune buone strategie.{/i}"
...
msgstr "[RT] {i}Abbiamo deciso che sarebbe bello visitare Diaz e vedere se lei può scavare un po 'di sporcizia su Matt. Probabilmente posso trovare il suo furgoncino sulla mia mappa in una serata di giorno della settimana.{/i}"
...
msgstr "[RT] {i}Ho bisogno di mettere una telecamera spia nello spogliatoio ragazze. Probabilmente sarebbe meglio andare al mattino presto prima che diventi affollato.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a scattare queste foto \"Womb Raider\" con Sidney fino a quando non avremo ogni tipo di foto di cui abbiamo bisogno.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 38 per iniziare a lavorare all'evento 40.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 40 per iniziare a lavorare all'evento 41.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare a fare una visita con Sidney nel mio letto stasera.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 39 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a visitare Diaz nel suo furgoncino fino al completamento di questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 31 prima di poter iniziare su questo evento NTR.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 37 prima di poter finire questo evento NTR.{/i}"
...
msgstr "[RT] {i}Se non aiutassi Lauren a fare bene sui numeri del sondaggio settimanale, potrebbe non piacermi le conseguenze.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 34 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Stessa cosa ogni fine settimana. Paga la mafia, abbraccia la mamma, ottieni un'erezione e lanciala sul pavimento.{/i}"
...
msgstr "[RT] {i}Si spera che qualcosa sarà diverso la prossima volta che pago il debito mafioso.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a visitare la mamma nel suo ufficio scolastico.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare gli eventi 7, 40 e 44 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Dovrei iniziare il servizio fotografico con Mamma e Megan andando al magazzino in una serata di un giorno della settimana.{/i}"
...
msgstr "[RT] {i}Ho bisogno di avere un bavaglio da qualche parte.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 45 prima di poter iniziare a lavorare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 46 prima di poter iniziare a lavorare su questo evento.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a costruire la sottomissione della mamma spingendola a fare nuove cose al photoshoot.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare gli eventi 10 e 40 prima di poter iniziare a lavorare all'evento 48.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 40 prima di poter iniziare a lavorare sull'evento 48.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 10 prima di poter iniziare a lavorare sull'evento 48.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a correre con Sidney durante la mattina presto nel parco per completare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 40 prima di poter iniziare a lavorare su questo evento.{/i}"
...
msgstr "[RT] {i}Sidney si comportava divertente quando le dissi di mamma. Farei meglio a tenerla d'occhio questo fine settimana quando la mafia viene per il loro pagamento settimanale.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 48 prima di poter iniziare a lavorare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di visitare Sidney mentre sta lavorando al club, forse avrà un po' di tempo per un po' di divertimento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 11 prima di poter iniziare a lavorare sull'evento 51.{/i}"
...
msgstr "[RT] {i}Scommetterò zia Cami sarà arrabbiata per le foto che ho scattato di Cousin Mandy. Dovrei solo aspettare la sua visita.{/i}"
...
msgstr "[RT] {i}Ho sentito voci che c'è stato un po' di calore su zio Bobby Mi chiedo se mi sentirò da lui presto.{/i}"
...
msgstr "[RT] {i}Mi chiedo di cosa si tratti. Dovrei andare al magazzino per vedere se lo zio Bobby è ok.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 51 prima di poter iniziare a lavorare sull'evento 52.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a visitare Sidney la sera fino a quando zia Cami viene di nuovo a visitare.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 52 prima di poter iniziare a lavorare sull'evento 53.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a visitare la lounge in tarda mattina fino a quando non vedo Zia Cami di nuovo.{/i}"
...
msgstr "[RT] {i}Dovrei continuare a andare in cucina in tarda mattina fino a quando non posso assegnare zia Cami a lavorare su.{/i}"
...
msgstr "[RT] {i}Ho bisogno di costruire la libido o la sottomissione di zia Cami in modo da poter fare qualcosa di ancora più malizioso per lei in bagno.{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 53 prima di poter iniziare a lavorare all'evento 54.{/i}"
...
msgstr "[RT] {i}Ho bisogno di costruire la libido o la sottomissione di zia Cami in modo da poter fare un affare con lei nella lounge.{/i}"
...
msgstr "[RT] {i}Ho bisogno di iniziare a lavorare all'evento 53 prima di poter iniziare a lavorare all'evento 55.{/i}"
...
msgstr "[RT] {i}Ho bisogno di costruire la libido o la sottomissione di zia Cami in modo da poter fare un accordo con lei in cucina.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 29 o 30 prima di poter iniziare questo evento.{/i}"

# game/Phone_event_screen.rpy:1398 ## translate crowdin event_info_56_8a3ebdbc:
msgid "[RT] {i}I also need to complete event 41.{/i}"
msgstr "[RT] {i}Ho anche bisogno di completare l'evento 41.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 41 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho una strana sensazione che qualcosa di strano sta per succedere a me. Forse la sensazione andrà via quando vado a dormire stasera.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 48 prima di poter iniziare l'evento 56.{/i}"
...
msgstr "[RT] {i}Ho bisogno di andare a correre con Sidney al mattino presto e provare tutto quello che ha da offrire al parco.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 13 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 14 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 53 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ora devo solo aspettare che succeda qualcosa prima della domenica mattina.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 57 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 58 prima di poter iniziare su questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di visitare Sidney al club e scegliere tutte le opzioni.{/i}"
...
msgstr "[RT] {i}Ho bisogno di visitare Sidney al club il lunedì notte.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 35 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 59 prima di poter completare questo evento.{/i}"
...
msgstr "[RT] {i}la signora Stone è pronta per quasi tutto... Mi chiedo fino a che punto andrà se continuerò a visitarla ogni settimana.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 58 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Penso di aver sentito Mandy guardare la TV nella lounge con Lauren la sera. Dovrei andare a vederla.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 39 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Dovrei parlare con Megan in classe di ciò che Diaz ha registrato nello spogliatoio.{/i}"
...
msgstr "[RT] {i}Mandy acquazzone sempre con Lauren, come la prenderò a masturbarsi?{/i}"
...
msgstr "[RT] {i}Aspetta! Non fa doccia da sola la domenica?... Se visito il bagno quando la sua libido è piena...{/i}"
...
msgstr "[RT] {i}Mandy sempre da solo nella sua stanza la sera. Mi chiedo cosa vedrò se la sua libido è piena.{/i}"
...
msgstr "[RT] {i}zia Cami acquista sempre nel pomeriggio, mi chiedo cosa vedrò se la spierò quando la sua libido è piena.{/i}"
...
msgstr "[RT] {i}zia Cami sempre da sola nella stanza della mamma la sera. Mi chiedo cosa vedrò se la sua libido è piena.{/i}"
...
msgstr "[RT] {i}Dovrei solo continuare a visitare la stanza di Lauren di notte. Voglio vedere dove condurrà.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 31 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di mantenere Lauren felice aiutandola a fare il meglio possibile nei sondaggi. Ho anche bisogno di completare l'evento 66 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di mantenere Lauren felice aiutandola a fare il meglio possibile nei sondaggi.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 67 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Con Cousin Mandy nella stanza di Lauren, le visite dell'agente Diaz potrebbero diventare interessanti. Dovrei comunque assicurarmi di pagare per tenerli al sicuro.{/i}"
...
msgstr "[RT] {i}Con Cousin Mandy nella stanza di Lauren, le visite dell'agente Diaz potrebbero diventare interessanti. Cosa succederebbe se non le pagasso?{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 42 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 62 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ho bisogno di continuare a visitare le riunioni della campagna pomeridiana di Lauren in bagno. È destinata ad avere un'idea che è il fuoco.{/i}"
...
msgstr "[RT] {i}devo visitare il membro del consiglio scolastico Will Tylor. Probabilmente posso trovare il suo ufficio sulla mia mappa nel tardo mattino o nel pomeriggio.{/i}"
...
msgstr "[RT] {i}Tylor vuole un appuntamento di scopata con mia mamma?... Dovrei aiutarlo?.. Cambiare il codice di abbigliamento garantirebbe quasi che Lauren vincere.{/i}"
...
msgstr "[RT] {i}Dovrei convincere la mamma ad andare a cena con lui però... non so se lo farebbe. Penso che lo odia... potrei chiederle a colazione. Sembra di essere di buon umore al mattino.{/i}"
...
msgstr "[RT] {i}Ho inviato Will un'email che gli fa sapere che mia mamma è disposta a incontrarlo per cena. Ora devo solo aspettare la sua risposta. Sono sicuro che non ci vorrà più di una settimana. Scommetto che lo manda il sabato quando ha un po' più di tempo.{/i}"
...
msgstr "[RT] {i}Dopo quello che io e Sidney abbiamo fatto nel club, mi chiedo se lei sarà disposta ad andare oltre al parco.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 59 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Dopo quello che io e Sidney abbiamo fatto nel club, mi chiedo se lei sarà disposta ad andare oltre nella camera da letto.{/i}"
...
msgstr "[RT] {i}Dopo quello che io e Sidney abbiamo fatto nel club, mi chiedo se lei sarà disposta ad andare oltre dopo un photoshoot.{/i}"
...
msgstr "[RT] {i}Dopo quello che io e Sidney abbiamo fatto nel club, mi chiedo se lei sarà disposta a continuare a farlo lì.{/i}"
...
msgstr "[RT] {i}Più eventi e influenza scolastica ottengo, meglio sarà il risultato delle elezioni. {p}L'elezione inizierà il venerdì. Ho solo bisogno di essere in classe quando inizia.{/i}"
...
msgstr "[RT] {i}Sarei meglio ad essere sicuro di aver completato tutti i miei compiti prima... Non sarò in grado di farlo dopo le elezioni.{/i}"
...
msgstr "[RT] {i}Ho bisogno di completare l'evento 76 prima di poter iniziare questo evento.{/i}"
...
msgstr "[RT] {i}Ora che Lauren è la presidente del corpo studentesco, riesce a leggere gli annunci del mattino. Dovrei ascoltarne alcuni il lunedì mattina.{/i}"
...
msgstr "[RT] {i}Scommetto che posso andare ancora più avanti con Lauren quando guardiamo la tv la sera.{/i}"
...
msgstr "[RT] {i}Penso che Lauren ed entrambi mi sento più arrapato dopo un photoshoot. Mi chiedo se posso spingere ulteriormente le cose dopo la nostra prossima sessione di foto.{/i}"
...
msgstr "[RT] {i}Scommetto che posso allevare con Lauren l'allevatore di drago dopo la nostra prossima sessione di foto.{/i}"
...
msgstr "[RT] {i}Con così tante persone in casa, è difficile prendere Lauren solo... Di solito lei acquista da solo presto il sabato. Potrebbe essere una buona occasione per un po 'di più divertimento.{/i}"
...
msgstr "[R] Poiché la serie di eventi che vi dirò, è così incredibile, renderebbe un grande film o serie televisiva."
...
msgstr "[WT] Questo è un tipico nella schermata di gioco. Come [ryan] accennato, otterrai molti oggetti nel gioco."
...
msgstr "[WT] mentre questo simbolo ti mostra l'ora del giorno."
...
msgstr "[WT] Sulla mappa del gioco, puoi andare in giro in molte località utilizzando i pulsanti di viaggio."
...
msgstr "[WT] Questo pulsante proprio qui aprirà una mappa della casa, dove puoi scegliere qualsiasi stanza che desideri andare."
...
msgstr "[R] No Mom!.... Ma sono davvero impegnato in questo momento!"
...
msgstr "[R] Ummm.... Homework.... ovviamente!"
...
msgstr "[M] Beh, ok.... Ma sai, non devi prenderti cura di te stesso, giusto?"
...
msgstr "[M] Sai, che se hai bisogno di sollievo, devi solo farmi sapere. E se sono troppo occupato, sono sicuro che le vostre sorelle sarebbero felici di aiutarvi."
...
msgstr "[R] È come ho detto.... Con così tanti personaggi ombreggiati intorno, tracciando i miei movimenti, ho bisogno di crescere più vicino alle persone che mi circondano."
...
msgstr "[WT] L'emoji arrabbiato sta per una rabbia delle ragazze nei tuoi confronti. È difficile convincerle a fare qualcosa per te quando sono pazze."
...
msgstr "[WT] Questa icona frusta, rappresenta una sottomissione di ragazze a te."
...
msgstr "[WT] E queste labbra rappresentano una libido di ragazze."
...
msgstr "[WT] Quindi sono tutte le punte che abbiamo per te. Tutto il resto dovrete capire da soli, o immagino che potreste sempre trovare la passeggiata, o chiedere aiuto online."
...
msgstr "[R] Immagino che la cosa migliore che posso fare, è raccontare la mia storia, e lasciare che chi guarda questo, sia il giudice delle mie azioni."
...
msgstr "[R] E ancora una volta, spero che questa storia si trasformi in un calcio culo serie HBO, e non un cazzo zoppo culo H-gioco."
...
msgstr "[R] Fino a quando non sono stato svegliato davvero presto un giorno, da una telefonata che avrebbe cambiato la mia vita per sempre...."
...
"             hints!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Premi \"{color=#E60000}???{/color}\" per vedere \n"
"             suggerimenti!"
msgstr[1] "Ignore this. translate only: One"
...
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Guarda di nuovo il tutorial!"
msgstr[1] "Ignore this. translate only: One"
